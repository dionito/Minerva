...
{
    private static readonly char[] FenSplitChars = { ' ' };
    private static readonly char[] RankSplitChars = { '/' };
    ...
    private static StringBuilder GeneratePiecePlacements(Board board)
    {
        ...
        for (int rank = 8; rank > 0; rank--)
        {
            ...
            for (int file = 1; file <= 8; file++)
            {
                ...
                char piece = board.GetPieceAt(BitBoards.Files[file - 1] & BitBoards.Ranks[rank - 1]);
