...
public partial class MainPage : ContentPage
{
    ...
    void DefendsButtonCheckChanged(object? sender, CheckedChangedEventArgs e)
    {
        ...
        if (this.board != null && sender is RadioButton radioButton)
        {
            ...
            ulong defendedSquares = this.board.CalculateDefendedSquaresByPiece(piece);
    ...
    void SetBoardData()
    {
        ...
        this.lblBlackBishopsBinary.Text =
            this.board != null
                ...
                : "0";
        this.lblBlackBishopsAttacks.Text = this.board?.CalculateDefendedSquaresByPiece(PieceFactory.GetPiece(PieceType.Bishop, Color.Black))
            .ToString("X16") ?? "0";
        ...
        this.lblBlackKingBinary.Text =
            this.board != null
                ...
                : "0";
        this.lblBlackKingAttacks.Text = this.board?.CalculateDefendedSquaresByPiece(PieceFactory.GetPiece(PieceType.King, Color.Black))
            .ToString("X16") ?? "0";
        ...
        this.lblBlackKnightsBinary.Text =
            this.board != null
                ...
                : "0";
        this.lblBlackKnightsAttacks.Text = this.board?.CalculateDefendedSquaresByPiece(PieceFactory.GetPiece(PieceType.Knight, Color.Black))
            .ToString("X16") ?? "0";
        ...
        this.lblBlackPawnsBinary.Text =
            this.board != null
                ...
                : "0";
        this.lblBlackPawnsAttacks.Text = this.board?.CalculateDefendedSquaresByPiece(PieceFactory.GetPiece(PieceType.Pawn, Color.Black))
            .ToString("X16") ?? "0";
        ...
        this.lblBlackQueensBinary.Text =
            this.board != null
                ...
                : "0";
        this.lblBlackQueensAttacks.Text = this.board?.CalculateDefendedSquaresByPiece(PieceFactory.GetPiece(PieceType.Queen, Color.Black))
            .ToString("X16") ?? "0";
        ...
        this.lblBlackRooksAttacks.Text = this.board?.CalculateDefendedSquaresByPiece(PieceFactory.GetPiece(PieceType.Rook, Color.Black))
            .ToString("X16") ?? "0";
        ...
        this.lblWhiteBishopsBinary.Text =
            this.board != null
                ...
                : "0";
        this.lblWhiteBishopsAttacks.Text = this.board?.CalculateDefendedSquaresByPiece(PieceFactory.GetPiece(PieceType.Bishop, Color.White))
            .ToString("X16") ?? "0";
        ...
        this.lblWhiteKingBinary.Text =
            this.board != null
                ...
                : "0";
        this.lblWhiteKingAttacks.Text = this.board?.CalculateDefendedSquaresByPiece(PieceFactory.GetPiece(PieceType.King, Color.White))
            .ToString("X16") ?? "0";
        ...
        this.lblWhiteKnightsBinary.Text =
            this.board != null
                ...
                : "0";
        this.lblWhiteKnightsAttacks.Text = this.board?.CalculateDefendedSquaresByPiece(PieceFactory.GetPiece(PieceType.Knight, Color.White))
            .ToString("X16") ?? "0";
        ...
        this.lblWhitePawnsBinary.Text =
            this.board != null
                ...
                : "0";
        this.lblWhitePawnsAttacks.Text = this.board?.CalculateDefendedSquaresByPiece(PieceFactory.GetPiece(PieceType.Pawn, Color.White))
            .ToString("X16") ?? "0";
        ...
        this.lblWhiteQueensBinary.Text =
            this.board != null
                ...
                : "0";
        this.lblWhiteQueensAttacks.Text = this.board?.CalculateDefendedSquaresByPiece(PieceFactory.GetPiece(PieceType.Queen, Color.White))
            .ToString("X16") ?? "0";
        ...
        this.lblWhiteRooksBinary.Text =
            this.board != null
                ...
                : "0";
        this.lblWhiteRooksAttacks.Text = this.board?.CalculateDefendedSquaresByPiece(PieceFactory.GetPiece(PieceType.Rook, Color.White))
            .ToString("X16") ?? "0";
    }
    ...
    private void MovesButtonCheckChanged(object? sender, CheckedChangedEventArgs e)
    {
        ...
        if (this.board != null && sender is RadioButton radioButton)
        {
            ...
            ulong legalMoves = this.board.CalculatePieceMoves(piece);
            if (legalMoves > 0)
            {
                for (int i = 0; i < 64; i++)
                {
